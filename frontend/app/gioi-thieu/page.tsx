  ...
  return (
    <div className="bg-white pt-24 pb-16">
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center mb-20" id="section-intro">
          ...
          <div className="w-full lg:w-5/12 space-y-4">
            <h2 className="text-2xl font-bold text-gray-800">Novas – THÔNG MINH VÀ HƠN NỮA</h2>
        ...
        <div className="mb-20 space-y-10" id="section-vision">
          <h2 className="text-3xl font-bold text-center text-gray-800">TẦM NHÌN & SỨ MỆNH</h2>
          
          <div className="space-y-8 max-w-[900px] mx-auto">
            <section>
              <h3 className="text-xl font-bold text-gray-800 mb-3">Tầm nhìn</h3>
              <p className="text-gray-600 leading-relaxed text-justify mb-4">
                Với sự nỗ lực không ngừng và chiến lược đầu tư phát triển bền vững Novas sẽ tiếp tục nâng cao năng lực cạnh tranh, mở rộng thị trường để tạo sự tin cậy với đối tác, khách hàng và trở thành 1 đơn vị hàng đầu phân phối các thiết bị vệ sinh tại Việt Nam.
              </p>
              <p className="text-gray-600 leading-relaxed text-justify">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-4 text-gray-600 text-justify">
                <li>
                ...
                <li>
                  Với cổ đông: Novas Việt Nam không chỉ đem lại mức lợi nhuận trong dài hạn mà còn thực hiện tốt các kế hoạch quản lý rủi ro. Từ đó, các cổ đông có thể yên tâm và có niềm tin tuyệt đối với các khoản đầu tư của mình.
                </li>
                <li>
                  Với đối tác: Novas Việt Nam sẽ tạo ra những giá trị bền vững cho các thành viên trong chuỗi cung ứng bằng cách đảm bảo mức lợi nhuận hợp lý thông qua các sản phẩm, dịch vụ ưu việt. Đồng thời chúng tôi đáp ứng nhu cầu tiêu dùng của khách hàng.
                </li>
              </ul>
            </section>
          </div>
        ...
        <div className="w-full mb-20 shadow-sm" id="middle-banner">
          ...
          <p className="text-center text-sm text-gray-400 mt-2 italic">Novas Showroom tại Việt Nam</p>
        </div>

        {/* Triết lý kinh doanh */}
        <div className="mb-20 max-w-[900px] mx-auto space-y-4" id="section-philosophy">
          <h3 className="text-xl font-bold text-gray-800">Triết lý kinh doanh</h3>
          <p className="text-gray-600 leading-relaxed text-justify">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center" id="section-advantages">
          <div className="w-full lg:w-1/2 space-y-4">
            <h2 className="text-2xl font-bold text-gray-800">ƯU ĐIỂM SẢN PHẨM</h2>
            <p className="text-gray-600 leading-relaxed text-justify">
